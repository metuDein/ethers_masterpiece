...
const ItemDetails = () => {
    ...
    const txTab = () => {
        return (
            <section className={`max-w-3xl bg-white absolute ${initiateTx ? 'top-[10%] ' : 'top-[-200%] '} left-[0] sm:left-[18%] p-4 sm:p-6 flex flex-col space-x-2 sm:flex-row mx-auto w-full rounded-2xl transition-all duration-500`}>
