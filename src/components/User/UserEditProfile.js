    ...
    const updateProfile = async (e) => {
        ...
        try {
            ...
            if (image) {
                ...
                const response = await axiosPrivate.patch('/users', JSON.stringify({ _id: user?._id, name: editName, username: editUserName, email: editEmail, password: editPassword, image: image }))
                console.log(response.data)
                alert('🎉 update successful')
            } else {
                const response = await axiosPrivate.patch('/users', JSON.stringify({ _id: user?._id, name: editName, username: editUserName, email: editEmail, password: editPassword }))
                console.log(response.data)
                alert('🎉 update successful')
            }
        } catch (error) {
