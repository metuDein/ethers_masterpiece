    ...
    return (
        <main className='bg-white dark:bg-black/90 w-full min-h-screen p-6 text-black dark:text-white'>
            <section className='max-w-4xl mx-auto'>
                ...
                <p className='text-[15px] ml-3'>Gas fees refer to the cost associated with validating and processing transactions on the blockchain. Users are responsible for paying the applicable gas fees associated with their transactions.</p>
